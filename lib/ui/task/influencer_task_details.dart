...
class InfluencerTaskDetails extends StatefulWidget {
  final TaskData taskData;
  final bool isLastIndex;

  const InfluencerTaskDetails(
      {Key? key, required this.taskData, required this.isLastIndex})
      : super(key: key);

  @override
  State<InfluencerTaskDetails> createState() => _InfluencerTaskDetailsState();
}

class _InfluencerTaskDetailsState extends State<InfluencerTaskDetails> {
  ...
  Widget showWidgets() {
    ...
    } else if (widget.taskData.taskType == 5) {
      if (taskStatus == "1" || taskStatus == "2") {

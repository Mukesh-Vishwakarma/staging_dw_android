...
class VideoReviewTaskDetails extends StatefulWidget {
  final TaskData taskData;
  final bool isLastIndex;

  const VideoReviewTaskDetails(
      {Key? key, required this.taskData, required this.isLastIndex})
      : super(key: key);

  @override
  State<VideoReviewTaskDetails> createState() => _VideoReviewTaskDetailsState();
}

class _VideoReviewTaskDetailsState extends State<VideoReviewTaskDetails> {

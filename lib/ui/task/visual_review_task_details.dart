...
class VisualReviewTaskDetails extends StatefulWidget {
  final TaskData taskData;
  final bool isLastIndex;

  const VisualReviewTaskDetails(
      {Key? key, required this.taskData, required this.isLastIndex})
      : super(key: key);

  @override
  State<VisualReviewTaskDetails> createState() =>
      _VisualReviewTaskDetailsState();
}

class _VisualReviewTaskDetailsState extends State<VisualReviewTaskDetails> {
  ...
  uploadMultiImage(List<XFile> list, String captions) async {
    setState(() {
      buttonLoaderStatus = true;
    });
    bool isOnline = await ApiClient.hasNetwork();
  ...
  void selectImages() async {
    ...
    if (selectedImages.isNotEmpty) {
      if(imageFileList != null && imageFileList!.isNotEmpty){
        if (selectedImages.length > 3-imageFileList!.length) {
          if (kDebugMode) {
            print("max 3 images allowed.. ");
          }
          if(selectedImages.length <= 3){
            if(selectedImages.length ==1){
              imageFileList![2] = selectedImages[0];
            }else if(selectedImages.length ==2){
              imageFileList![1] = selectedImages[0];
              imageFileList![2] = selectedImages[1];
            }else{
              imageCache.clear();
              imageFileList!.clear();
            ...
            Fluttertoast.showToast(msg: "Maximum 3 images allowed..");
          }
          ...
          if(imageFileList!.length>3 || imageFileList!.length==3){
            Fluttertoast.showToast(msg: "Maximum 3 images allowed..");
          }else{
            imageCache.clear();
            imageFileList!.addAll(selectedImages);
  ...
  Widget showWidgets() {
    ...
    /*else if (widget.taskData.taskType == 3) {
      ...
      if (taskStatus == "1" || taskStatus == "2") {
        return taskFourGetWidgets();
      } else if (taskStatus == "3") {
        return taskFourRejectWidgets();
      } else {
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    taskDetailsModel.taskDetail![2].title!,
                                    style: const TextStyle(
                                        color: secondaryColor,
                                        fontSize: 16.0,
                                        fontWeight: FontWeight.w600),
                        ...
                        child: (!buttonLoaderStatus)
                          ...
                          onPressed: () {
                            if (imageFileList!.isEmpty) {
                              ...
                              uploadMultiImage(
                                  imageFileList!, textController.text.trim());
                              //uploadImage(selectedImage!, imageName);
                              //  saveTaskDetails(selectedImage!, imageName);
                            }
                          },
                        ...
                        child: (!buttonLoaderStatus)
                          ...
                          onPressed: () {
                            if (imageFileList!.isEmpty) {
                              ...
                              uploadMultiImage(imageFileList!,
                      ...
                      Expanded(
                        child: ButtonWidget(
                          ...
                          onPressed: () {
                            ...
                            }else if (textController.text.trim().contains(
                                RegExp(emojiRegex))) {
                              Fluttertoast.showToast(
                                  msg: "Emojis not acceptable");
                            }   else {
...
/*Widget showSocialIcon() {
    if(taskDetailsModel.social_icon_type =="1"){
      return Image.asset(
        "assets/images/facebook.png", width: 20,
        height: 20,);
    }else if(taskDetailsModel.social_icon_type =="2"){
      return Image.asset(
        "assets/images/instagram.png", width: 20,
        height: 20,);
    }if(taskDetailsModel.social_icon_type =="3"){
      return Image.asset(
        "assets/images/twitter.png", width: 20,
        height: 20,);
    }if(taskDetailsModel.social_icon_type =="4"){
      return Image.asset(
        "assets/images/youtube.png", width: 20,
        height: 20,);
    }if(taskDetailsModel.social_icon_type =="5"){
      return Image.asset(
        "assets/images/pinterest.png", width: 20,
        height: 20,);
    }else{
      return Image.asset(
        "assets/images/linkedin.png", width: 20,
        height: 20,);
    }
  }*/
}

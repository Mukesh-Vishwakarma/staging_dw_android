                          ...
                          return Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Expanded(child:
                                  Text(
                                    title ?? widget.placeholder, overflow: TextOverflow.ellipsis,
                                    style: title != null ? const TextStyle(
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Icon(Icons.keyboard_arrow_down, size: 30.0, color: primaryColor),
                                    /*child: Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          if (!showClearButton) const Icon(Icons.keyboard_arrow_down, size: 30.0, color: primaryColor),
                                        ],
                                      )*/
                                  ),
                                ),
